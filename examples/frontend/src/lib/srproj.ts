...
export type Architecture = "Real-ESRGAN" | "SwinIR" | "HAT" | "EDSR";
export type RunStatus = "configured" | "running" | "paused" | "completed" | "failed" | "crashed";
