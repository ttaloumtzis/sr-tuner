...
import { buildYaml } from "../../lib/yamlBuilder";
...
const ARCH_DEFS: ArchDef[] = [
  ...
  {
    id: "HAT",
    tag: "Transformer · SOTA",
    description: "Hybrid Attention Transformer. State-of-the-art performance, highest VRAM.",
    vram: "~10 GB",
    params: "~20M",
    defaults: {
      scale: 4,
  ...
  },
  {
    id: "EDSR",
    tag: "ResNet · Stable",
    description: "Enhanced Deep SR ResNet. Stable training, lower VRAM, fast convergence.",
    vram: "~4 GB",
    params: "~43M",
    defaults: {
      scale: 4,
...
export function ScreenModelConfig() {
  ...
  const regenerateYaml = useCallback(() => {
    setYaml(buildYaml(arch, hp, lw, aug, pretrainedPath));
