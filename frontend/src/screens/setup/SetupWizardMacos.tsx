...
export function SetupWizardMacos({ step, systemInfo, onStart, onBack, onNext }: Props) {
        ...
        <>
          ...
          <div style={infoRowStyle}>
            ...
            <span style={valueStyle}>
              {systemInfo.mps_available ? "Apple Silicon (MPS)" : "Intel (CPU)"}
            </span>
          </div>
          <div style={infoRowStyle}>
            <span>ffmpeg:</span>
            <span style={{ ...valueStyle, color: systemInfo.has_ffmpeg ? "var(--green)" : "var(--amber)" }}>
              {systemInfo.has_ffmpeg ? "Found" : "Install with: brew install ffmpeg"}
            </span>
          </div>
          <div style={infoRowStyle}>
            <span>uv:</span>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ color: "var(--dim)", fontSize: 10, marginTop: 2 }}>
                    {b === "mps" && "Apple Silicon GPU acceleration (Metal)"}
                    {b === "cpu" && "CPU only"}
                  </div>
                </div>
              </label>
      ...
      {step === 2 && (
        <>
          ...
          <div style={{ fontSize: 11, color: "var(--dim)", textAlign: "center" }}>
            ...
            Sidecar is not available on macOS in this version.
          </div>
