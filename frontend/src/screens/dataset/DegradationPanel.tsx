...
function RangeRow({ label, min, max, valueMin, valueMax, onMin, onMax, step = 1, unit = "" }: {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
      <span style={{ fontSize: 10, color: "var(--muted)", minWidth: 70 }}>{label}</span>
      <input
        type="number" value={valueMin} min={min} max={max} step={step}
        onChange={(e) => onMin(Number(e.target.value))}
        style={{ width: 60, background: "var(--bg3)", border: "1px solid var(--border)", borderRadius: "var(--radius-sm)", color: "var(--text)", fontSize: 10, padding: "2px 6px", fontFamily: "var(--font-mono)", outline: "none" }}
      />
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <input type="number" value={s.frameRate} min={1} max={120} onChange={(e) => s.setFrameRate(Number(e.target.value))}
                style={{ width: 50, background: "var(--bg3)", border: "1px solid var(--border)", borderRadius: "var(--radius-sm)", color: "var(--text)", fontSize: 10, padding: "2px 6px", fontFamily: "var(--font-mono)", outline: "none" }} />
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <DegSection title="Blur" enabled={s.degBlur} onToggle={s.setDegBlur}>
            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ fontSize: 10, color: "var(--muted)", minWidth: 70 }}>Gaussian kernel</span>
                ...
                {s.motionBlurEnabled && (
                  <>
                    ...
                    <input type="number" value={s.motionBlurMaxKernel} min={3} max={99} step={2} onChange={(e) => s.setMotionBlurMaxKernel(Number(e.target.value))}
                      style={{ width: 45, background: "var(--bg3)", border: "1px solid var(--border)", borderRadius: "var(--radius-sm)", color: "var(--text)", fontSize: 10, padding: "2px 6px", fontFamily: "var(--font-mono)", outline: "none" }} />
          ...
          <DegSection title="Noise" enabled={s.degNoise} onToggle={s.setDegNoise}>
            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ fontSize: 10, color: "var(--muted)", minWidth: 70 }}>Salt & pepper</span>
                <input type="number" value={s.saltPepperAmount} min={0} max={0.1} step={0.001} onChange={(e) => s.setSaltPepperAmount(Number(e.target.value))}
                  style={{ width: 55, background: "var(--bg3)", border: "1px solid var(--border)", borderRadius: "var(--radius-sm)", color: "var(--text)", fontSize: 10, padding: "2px 6px", fontFamily: "var(--font-mono)", outline: "none" }} />
          ...
          <DegSection title="Color Jitter" enabled={s.degColorJitter} onToggle={s.setDegColorJitter}>
            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ fontSize: 10, color: "var(--muted)", minWidth: 70 }}>Hue</span>
                <span style={{ fontSize: 10, color: "var(--dim)" }}>±</span>
                <input type="number" value={s.jitterHueRange} min={0} max={0.5} step={0.01} onChange={(e) => s.setJitterHueRange(Number(e.target.value))}
                  style={{ width: 55, background: "var(--bg3)", border: "1px solid var(--border)", borderRadius: "var(--radius-sm)", color: "var(--text)", fontSize: 10, padding: "2px 6px", fontFamily: "var(--font-mono)", outline: "none" }} />
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ fontSize: 10, color: "var(--muted)", minWidth: 70 }}>Saturation</span>
                <span style={{ fontSize: 10, color: "var(--dim)" }}>±</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ fontSize: 10, color: "var(--muted)", minWidth: 70 }}>Value</span>
                <span style={{ fontSize: 10, color: "var(--dim)" }}>±</span>
